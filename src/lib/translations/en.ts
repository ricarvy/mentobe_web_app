export const en = {
  ...
  privacyPolicy: {
    ...
    cookiePolicy: {
      ...
      types: {
        ...
        essential: 'Essential Cookies',
        essentialDesc: 'These cookies are strictly necessary to provide you with services available through our Website and to use some of its features, such as access to secure areas.',
        analytics: 'Analytics and Customization Cookies',
        analyticsDesc: 'These cookies collect information that is used either in aggregate form to help us understand how our Website is being used or how effective our marketing campaigns are, or to help us customize our Website for you.',
      },
      control: {
    ...
    gdpr: {
      ...
      lastUpdated: 'Last Updated: ',
      introduction: 'Mentobe AI is committed to ensuring the security and protection of the personal information that we process, and to provide a compliant and consistent approach to data protection. We have always had a robust and effective data protection program in place which complies with existing law and abides by the data protection principles.',
      rights: {
        title: 'Your Rights Under GDPR',
        access: 'The Right to Access',
        accessDesc: 'You have the right to request copies of your personal data.',
        rectification: 'The Right to Rectification',
        rectificationDesc: 'You have the right to request that we correct any information you believe is inaccurate or complete information you believe is incomplete.',
        erasure: 'The Right to Erasure',
        erasureDesc: 'You have the right to request that we erase your personal data, under certain conditions.',
        restrict: 'The Right to Restrict Processing',
        restrictDesc: 'You have the right to request that we restrict the processing of your personal data, under certain conditions.',
        object: 'The Right to Object to Processing',
        objectDesc: 'You have the right to object to our processing of your personal data, under certain conditions.',
        portability: 'The Right to Data Portability',
        portabilityDesc: 'You have the right to request that we transfer the data that we have collected to another organization, or directly to you, under certain conditions.',
      },
      contact: {
        title: 'Contact Us',
        content: 'If you wish to exercise any of these rights or have questions about how we handle your data, please contact us at contact@mentobai.com.',
      },
    },
    disclaimer: {
      title: 'Disclaimer',
      lastUpdated: 'Last Updated: ',
      introduction: 'The information provided by Mentobe AI ("we," "us," or "our") on our website and through our services is for general entertainment purposes only. All information is provided in good faith, however we make no representation or warranty of any kind, express or implied, regarding the accuracy, adequacy, validity, reliability, availability, or completeness of any information.',
      entertainment: {
        title: 'For Entertainment Purposes Only',
        content: 'Our tarot readings, AI interpretations, and other mystical services are designed for entertainment and self-reflection purposes only. They should not be taken as absolute predictions of the future or as factual statements about your life.',
      },
      professional: {
        title: 'Not Professional Advice',
        content: 'The content provided by Mentobe AI is not intended to be a substitute for professional advice. Always seek the guidance of qualified professionals regarding:',
        medical: 'Medical conditions or health concerns',
        legal: 'Legal matters or disputes',
        financial: 'Financial decisions or investments',
        psychological: 'Mental health or psychological issues',
      },
      ai: {
        title: 'AI Limitations',
        content: 'Our interpretations are generated by Artificial Intelligence. While we strive for quality and relevance, AI may occasionally generate incorrect, irrelevant, or nonsensical information. Users should use their own judgment when interpreting the readings.',
      },
      liability: {
  ...
  pricing: {
    ...
    plans: {
      ...
      pro: {
        name: 'Pro',
        description: 'Top choice for Tarot lovers',
        price: '19.9',
        period: '/month',
        features: [
          'Unlimited AI readings',
          'Unlock pro-level spreads',
          'Unlimited Book of Answers',
          'Unlock AI palm reading',
          '30 history records',
        ],
        button: 'Subscribe Now',
        buttonRenew: 'Renew',
        buttonUpgrade: 'Upgrade',
        buttonDowngrade: 'Downgrade Not Allowed',
        popular: true,
      },
      premium: {
        name: 'Premium',
        description: 'Ideal for deep explorers',
        price: '109.9',
        period: '/year',
        features: [
          'Unlimited access to all features',
          'Unlock advanced spreads (6+ cards)',
          'Complete history records',
          'Priority response and support',
          'Deep interpretation solutions',
        ],
        button: 'Subscribe Now',
        buttonRenew: 'Renew',
        buttonUpgrade: 'Upgrade',
  ...
  payment: {
    ...
    success: {
      ...
      autoRedirect: 'Returning to home in {0} seconds...',
