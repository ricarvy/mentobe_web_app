          ...
          >
            ...
            >
              {!flippedCards.has(index) ? (
                <div className="w-full h-full bg-gradient-to-br from-purple-900 to-pink-900 rounded-lg border-2 border-purple-500/50 flex items-center justify-center">
                ...
                <div className="w-full h-full bg-gradient-to-br from-purple-800 to-pink-800 rounded-lg border-2 border-purple-400/50 p-2 flex flex-col items-center justify-center">
